...
function toggleFields() {
  if (individualRadio.checked) {
    ...
    var selectedApplicantType = document.querySelector('input[name="applicantIs"]:checked');
    if (selectedApplicantType) {
      if (selectedApplicantType.value === 'primaryApplicant') {
    ...
    var selectedApplicantTypeBusiness = document.querySelector('input[name="applicantIs"]:checked');
    if (selectedApplicantTypeBusiness) {
      if (selectedApplicantTypeBusiness.value === 'primaryApplicant') {
